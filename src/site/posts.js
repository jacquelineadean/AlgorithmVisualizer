...
export const POSTS = [
    {
        ...
        body: [
            ...
            'Six visualizations are live today: RSA, Diffie–Hellman, Dijkstra’s algorithm, quicksort, merge sort, and Bayes’ rule — the last of which also runs the home page, where the hero graphic is the algorithm itself rather than decoration. The roadmap adds the transformer serving stack as a clickable architecture map, statistics classics, and distributed consensus — each under the same rule.',
        ],
    },
];
