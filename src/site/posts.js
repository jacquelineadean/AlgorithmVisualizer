...
export const POSTS = [
    {
        ...
        body: [
            ...
            'Four visualizations are live today: RSA, Diffie–Hellman, Dijkstra’s algorithm, and Bayes’ rule — the last of which also runs the home page, where the hero graphic is the algorithm itself rather than decoration. The roadmap adds sorting, the transformer serving stack as a clickable architecture map, and distributed consensus — each under the same rule.',
        ],
    },
];
